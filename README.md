...
Binary is a nodal non-linear data structure. This concept covers

* What is a binary tree
* What is the difference between a binary tree and a Binary Search Tree
* What is the possible gain in terms of time complexity compared to linked lists(best to know master theorem)
